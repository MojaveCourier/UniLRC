...
namespace ECProject
{
  ...
  public:
    ...
    bool get_degraded_read_block(int stripe_id, int failed_block_id, std::string &value, double &disk_io_time, double &network_time, double &encode_time);
    int recovery(int stripe_id, int failed_block_id, double &disk_io_time, double &network_time, double &decode_time);
